...
import { BellIcon, HomeIcon, UserIcon, WebcamIcon } from "lucide-react";

const Sidebar = () => {
  //grab current user detail for display
  ...
  return (
    <aside className="w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky-top-0">
      ...
      {/*User profile section - FLEX-1 nav push this section to bottom */}
